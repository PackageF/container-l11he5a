...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-l11he5a.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-l11he5a.containers.anotherwebservice.com/
...
```
git clone git@github.com:PackageF/container-l11he5a.git
cd container-l11he5a
```
...
```
docker attach container-l11he5a
```
